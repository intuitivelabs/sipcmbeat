...
replace (
	...
	github.com/intuitivelabs/anonymization => github.com/intuitivelabs/anonymization v1.4.2-0.20220425150840-f9004de7ebff
...
require (
	...
	github.com/intuitivelabs/sipcallmon v0.8.13
